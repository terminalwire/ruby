...
Gem::Specification.new do |spec|
  spec.name        = "terminalwire-v2"
  spec.version     = Terminalwire::V2::VERSION
  spec.authors     = ["Brad Gessler"]
  spec.email       = ["brad@terminalwire.com"]

  # NOT FOR RELEASE YET. Developed in-tree; will be versioned + published to
  # RubyGems when the time comes. The guard + invalid push host below keep it
  # from shipping by accident.
  if $PROGRAM_NAME.end_with?("gem") && ARGV.first&.match?(/\A(build|push|release)\z/)
    raise "terminalwire-v2 is not ready to ship — do not build/push this gem yet."
  end
